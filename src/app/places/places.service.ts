...
export class PlacesService {
  ...
  loadHealthChanges__(userId: string): Observable<HealthChange[]> {
    return this.http
      .get<HealthChange[]>(`${this.healthChangeUrl}/listByUserId/${userId}`)
      .pipe(
        map((healthChanges) => {
          console.log('loadHealthChanges result: ', healthChanges);
